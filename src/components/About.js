...
const About = () => {
  return (
    <section id="section" className="about_me">
      <div className="flex-row container-partial-width section-container">
        <div className="about-profile-layout">
          ...
          <div className="about-profile-text">
            ...
            <p>
              I am obsessed with coding and building things for the web. I love
              to follow along with the progressions of my fave javascript
              frameworks, javascript evolutions, and web development. Along with
              coffee I enjoy reading other people's thoughts on coding,
              navigating the industry, and the future in tech. Lets chat about
              how I can help you in your next or current project.
            </p>
